...
export default function ContextBlock({ title, body }: { title: string; body: string }) {
  return (
    <section className="px-6 md:px-10 py-24 border-t border-neutral-900">
      <div className="max-w-6xl mx-auto">
        <ScrollReveal>
          <p className="text-sm font-mono text-neutral-600 mb-4 tracking-widest uppercase">Context</p>
        </ScrollReveal>
