  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center px-6 md:px-10 pt-24 pb-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-none text-white">
          <TextScramble text="AZHAR" delay={800} duration={1000} />
        </h1>
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-none text-neutral-800 mt-[-0.06em]">
