...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: 'Single-backbone Vision Transformer pipeline for pneumonia detection from chest X-rays. Removed traditional CLAHE preprocessing entirely, cutting latency by 40% while maintaining clinical-grade accuracy. Deployed via Docker on Hugging Face Spaces.',
