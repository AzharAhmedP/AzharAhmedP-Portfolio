...
export const projects: Project[] = [
  {
    ...
    summary: 'End-to-end mobile plant disease detection system: YOLOv8 localizes and crops leaves from noisy field photos, then a Vision Transformer classifies 38 disease classes across 13 crop species at 93% accuracy. Exposed through FastAPI with a Groq-powered chatbot, served via React Native.',
    ...
    contribution: 'Model development (YOLOv8 detection pipeline, ViT classification fine-tuning), FastAPI backend, Groq chatbot integration, and deployment on Hugging Face Spaces.',
    challenge: {
    ...
    performance: [
      ...
      { label: 'Pipeline Stages', value: '2-stage' },
    ...
    dataset: [
      ...
      { label: 'Data Sources', value: 'PlantDoc + PlantVillage' },
      { label: 'Augmentation', value: 'Rotation, flip, crop' },
    ],
  ...
  },
  {
    ...
    summary: 'Single-backbone Vision Transformer pipeline for pneumonia detection from chest X-rays. Removed traditional CLAHE preprocessing entirely, cutting inference latency by 40%. Deployed via Docker on Hugging Face Spaces.',
    ...
    disclaimer: 'Educational/research project \u2014 not intended for clinical diagnosis or medical decision-making.',
    contribution: 'End-to-end pipeline: ViT model fine-tuning, Flask backend, Docker containerization, and Hugging Face Spaces deployment.',
    challenge: {
      title: 'Balancing speed and accuracy.',
      body: 'Medical imaging demands both high accuracy and low latency. Ensemble approaches improve accuracy but add inference time. Switched to a single ViT backbone with global attention, removing traditional preprocessing (CLAHE) entirely \u2014 cutting latency by 40% while maintaining strong classification performance.',
    },
    performance: [
    ...
    dataset: [
      { label: 'Base Model', value: 'Pre-trained ViT' },
    ...
    sections: [
      {
        ...
        body: 'Pneumonia remains one of the leading causes of death worldwide, and chest X-ray interpretation can be subjective and time-consuming. PneumoDetect leverages Vision Transformers to provide instant, AI-powered pneumonia detection from chest X-rays, designed with a clean clinical interface that puts diagnostics at your fingertips.',
      },
      {
        type: 'vision',
      ...
      },
      {
        ...
        layers: [
          { name: 'Frontend', tech: ['HTML5', 'CSS3', 'JavaScript'], description: 'Clean interface with glassmorphism effects, fluid animations, and real-time scan feedback.' },
          { name: 'Backend', tech: ['Flask', 'Python'], description: 'Streamlined Flask backend handling image upload and ViT inference.' },
  ...
  },
  {
    ...
    contribution: 'End-to-end pipeline: DistilBERT fine-tuning with optimized sampling, Flask web application, session logging system, and Hugging Face Spaces deployment.',
    challenge: {
  ...
  },
  {
    ...
    summary: 'Compared Logistic Regression, Decision Tree, and Random Forest on a CVD dataset with GridSearchCV tuning. Optimized for recall to minimize false negatives — the most critical metric in medical diagnosis.',
  ...
  },
  {
    ...
    summary: 'Multi-layer ANN (128-64-1) on California Housing data with dropout regularization and early stopping. Demonstrates that deep learning generalizes on structured tabular data when properly regularized.',
  ...
  },
  {
    ...
    summary: 'CNN pipeline classifying 60K grayscale images across 10 clothing categories. Alternating Conv2D + MaxPooling for hierarchical feature extraction with dropout regularization. 90.12% accuracy, 89.93% F1-score.',
  ...
  },
  {
    ...
    summary: 'Streamlit dashboard that replaces manual EDA boilerplate: upload any CSV and instantly get descriptive stats, 6 visualization types, missing-value handling, and downloadable summary reports.',
