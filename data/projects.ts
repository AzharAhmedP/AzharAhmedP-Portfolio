...
export const personalInfo = {
  ...
  taglineSub: 'Trained models. Shipped apps. Running in production.',
  ...
  about: `Data Scientist and AI/ML Developer pursuing a BS in Information Technology at the University of Sindh. I build end-to-end machine learning systems — from data preprocessing and model training to API deployment and real-world applications across computer vision, NLP, and predictive analytics.`,
  skillCategories: [
    { label: 'LANGUAGES & FUNDAMENTALS', items: ['Python', 'SQL', 'Java', 'Git/GitHub'] },
    { label: 'DATA SCIENCE', items: ['Pandas', 'NumPy', 'Matplotlib', 'Seaborn', 'Scikit-learn', 'EDA'] },
    { label: 'MACHINE LEARNING', items: ['XGBoost', 'LightGBM', 'Classification', 'Regression', 'Clustering', 'GridSearchCV'] },
    { label: 'DEEP LEARNING', items: ['PyTorch', 'TensorFlow', 'Keras', 'CNNs', 'RNN/LSTM', 'Transfer Learning'] },
    { label: 'COMPUTER VISION', items: ['OpenCV', 'YOLO', 'Vision Transformers', 'Object Detection', 'Image Classification'] },
    { label: 'NLP & GENERATIVE AI', items: ['Transformers', 'BERT', 'Hugging Face', 'LangChain', 'RAG', 'LLM APIs'] },
    { label: 'DEPLOYMENT', items: ['FastAPI', 'Flask', 'Docker', 'Hugging Face Spaces', 'Streamlit'] },
  ],
  process: [
    {
      step: '01',
  ...
  certifications: [
    { title: 'Claude 101', issuer: 'Anthropic', date: 'Jul 2026', image: '/images/certifications/Claude101.jpg', tier: 'primary' as const },
    { title: 'Certified Java Developer', issuer: 'People\'s IT Training Programme (PITP) \u2014 MUET', date: 'Feb 2026', image: '/images/certifications/Cert_JavaDev.jpg', tier: 'primary' as const },
    { title: 'Artificial Intelligence & Data Science', issuer: 'Saylani Mass IT Training', date: 'May 2026', image: '/images/certifications/Cert_AiDS.jpg', tier: 'primary' as const },
    { title: 'Introduction to Modern AI', issuer: 'Cisco Networking Academy (NetAcad)', date: 'Mar 2026', image: '/images/certifications/Intro_to_ModernAi.jpg', tier: 'primary' as const },
    { title: 'Certified Web Developer', issuer: 'People\'s IT Training Programme (PITP) \u2014 MUET', date: 'Jan 2025', image: '/images/certifications/Cert_WebDev.jpg', tier: 'secondary' as const },
    { title: 'Academic Excellence Award \u2014 Java Development', issuer: 'People\'s IT Training Programme (PITP)', date: 'Feb 2026', image: '/images/certifications/Java_Award.jpg', tier: 'secondary' as const },
    { title: 'Coding Night 2025 \u2014 Hackathon', issuer: 'Saylani Mass IT Training', date: 'Nov 2025', image: '/images/certifications/Cert_CodingNight.jpg', tier: 'secondary' as const },
    { title: 'FYP 2026 \u2014 Certificate of Appreciation', issuer: 'University of Sindh', date: 'Feb 2026', image: '/images/certifications/AppCert_FYP2026.jpg', tier: 'other' as const },
    { title: 'FET Sports Gala 2025 \u2014 Certificate of Appreciation', issuer: 'University of Sindh', date: 'Nov 2025', image: '/images/certifications/AppCert_SG2025.jpg', tier: 'other' as const },
  ],
  languages: [
